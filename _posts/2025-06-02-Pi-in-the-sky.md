...
### Payloads
There were 2 scientific payloads onboard of the gondola, our self developed [UV spectrometer](#) to measure trace gas concentrations in the atmosphere and a highschool experiment on an Arduino by the **Vrij Technisch Instituut** in **Ieper** measuring exterior and interior temperatures and atmospheric pressure. Allowing for the creation of altitude, ascent rate and temperature graphs.
