...
Since then, measuring the Doppler shift of this specific frequency has become a staple project for aspiring radio amateurs. By comparing the observed frequency from observed Hydrogen clouds to the known laboratory value of $1420\;405\;751.768 \pm 0.002 \; \mathrm{Hz}$[^Hline], the precise radial velocities can be calculated. But why is this radiation emitted at this exact frequency?
...
The electron bound to the proton in hydrogen can be treated as a system of two magnetic dipoles whose relative orientation may be parallel or antiparallel. The proton’s spin gives rise to an intrinsic magnetic moment, which produces a magnetic field overlapping with the region occupied by the electron. The electron, having both charge and spin, likewise carries a magnetic moment.

![Bar magnet](Bar_magnet_Transition.png){: style="max-width: 500px; height: auto;"}
*Transition between parallel and antiparallel spin orientations of the electron and proton in hydrogen, represented by bar magnets.*

Quantum mechanically, the antiparallel spin configuration corresponds to parallel magnetic dipole moments, which attract like parallel currents and therefore yield a lower-energy state. By contrast, the parallel spin configuration produces antiparallel dipole moments, which repel, giving the system a slightly higher energy.[^B_field]
